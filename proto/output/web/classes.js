...
cprn_NetworkProvider__init_ = ($this, $reconnectRunnable, $sendFailRunnable) => {
    jl_Object__init_($this);
},
...
cprn_EmptyNetworkProvider__init_ = $this => {
    cprn_EmptyNetworkProvider_$callClinit();
    cprn_NetworkProvider__init_($this, cprn_EmptyNetworkProvider_emptyRunnable, cprn_EmptyNetworkProvider_emptyRunnable);
},
...
cpr_RPGMain__init_0 = (var$0, var$1) => {
    cpr_RPGMain_$callClinit();
    cpr_RPGMain__init_(var$0, null, 0, var$1);
},
cpr_RPGMain__init_1 = var_0 => {
    let var_1 = new cpr_RPGMain();
    cpr_RPGMain__init_0(var_1, var_0);
    return var_1;
},
cpr_RPGMain__init_ = (var$0, var$1, var$2, var$3) => {
    let var$4, var$5;
    cpr_RPGMain_$callClinit();
    var$4 = 1;
    cbg_b__init_(var$0);
...
cpr_RPGMain__init_2 = (var_0, var_1, var_2) => {
    ...
    cpr_RPGMain__init_(var_3, var_0, var_1, var_2);
    return var_3;
};
function cbgg_b() {
    let a = this; jl_Object.call(a);
...
cprnm_ItemType_REEL_FAMILY_TREE_OF_UMLAUT = null,
...
let cprnm_ItemType_REEL_FINS_OF_SEA_DRAGON = null,
...
cprnm_ItemType_REEL_NECRONOMICON = null,
...
let cprnm_ItemType_REEL_ORNATE_CROWN_OF_THE_GM = null,
...
cprnm_ItemType_REEL_TOME_OF_CURSED_HORTICULTURE = null,
...
let cprnm_ItemType_REEL_UPHOLSTERED_THRONE = null,
...
cprnm_ItemType_SHARD_DONT_TASE_ME_BOW = null,
...
let cprnm_ItemType_SHARD_DRAGON_BLANKIE = null,
...
cprnm_ItemType_SHARD_REEL_BANANA_PEEL_MOUNTAIN = null,
...
let cprnm_ItemType_SHARD_REEL_BLACKSMITH_BREW = null,
...
cprnm_ItemType_SHARD_REEL_EXPLOSIVE_CANNON = null,
...
let cprnm_ItemType_SHARD_REEL_FEATHER_OF_PHOENIX = null,
...
cprnm_ItemType_SHARD_REEL_NECRONOMICON = null,
...
let cprnm_ItemType_SHARD_REEL_ORNATE_CROWN_OF_THE_GM = null,
...
cprnm_ItemType_SHARD_RINGS_OF_A_FEATHER = null,
...
let cprnm_ItemType_SHARD_ROLL_OF_DUCT_TAPE = null,
...
cprnm_ItemType_SKIN_BARDBARIAN_MASTERY = null,
...
let cprnm_ItemType_SKIN_BONE_DRAGON_MASTERY = null,
...
cprnm_ItemType_SKIN_DRAGZILLA_ZILLA = null,
...
let cprnm_ItemType_SKIN_DUNGEON_MAN_MASTERY = null,
...
cprnm_ItemType_SKIN_NINJA_DWARF_MASTERY = null,
...
let cprnm_ItemType_SKIN_ORC_MONK_ORCS = null,
...
cprnm_ItemType_SKIN_SPIKEY_DRAGON_MECHA = null,
...
let cprnm_ItemType_SKIN_STOWAWAY_BUISNESS = null,
...
cprnm_ItemType_SWORDY_MCEPICPANTS = null,
...
let cprnm_ItemType_TEAM_XP_BONUS_ITEM_24_HOUR = null,
...
cprnm_HeroLineupType_values0 = null,
...
let cprnm_HeroLineupType__init_ = (var_0, var_1) => {
...
cpru_DeviceInfo = $rt_classWithoutFields(0),
WebDeviceInfo = $rt_classWithoutFields(),
WebDeviceInfo__init_ = $this => {
    jl_Object__init_($this);
},
WebDeviceInfo__init_0 = () => {
    let var_0 = new WebDeviceInfo();
    WebDeviceInfo__init_(var_0);
    return var_0;
},
...
cprn_EmptyNetworkProvider$1__init_ = $this => {
    jl_Object__init_($this);
},
...
DragonSoulLauncher_main = $args => {
    let $deviceInfo, $game;
    DragonSoulLauncher_$callClinit();
    (jl_System_out()).$println($rt_s(1678));
    $deviceInfo = WebDeviceInfo__init_0();
    $game = cpr_RPGMain__init_1($deviceInfo);
    (jl_System_out()).$println($rt_s(1679));
},
DragonSoulLauncher__clinit_ = () => {
    return;
},
...
cprnm_TimeType__clinit_ = () => {
    ...
    cprnm_TimeType_LAST_NON_FREE_TIME_ZONE_CHANGE = cprnm_TimeType__init_($rt_s(1682), 1);
    cprnm_TimeType_CHAT_SILENCE_END = cprnm_TimeType__init_($rt_s(1683), 2);
    cprnm_TimeType_MONTHLY_DIAMOND_END = cprnm_TimeType__init_($rt_s(1684), 3);
    cprnm_TimeType_LAST_DAILY_RESET = cprnm_TimeType__init_($rt_s(1685), 4);
    cprnm_TimeType_LAST_MONTHLY_SIGNIN = cprnm_TimeType__init_($rt_s(1686), 5);
    cprnm_TimeType_LAST_SPECIAL_EVENT_CHECK = cprnm_TimeType__init_($rt_s(1687), 6);
    cprnm_TimeType_LAST_USER_DAILY_RESET = cprnm_TimeType__init_($rt_s(1688), 7);
    cprnm_TimeType_LAST_EVENT_VIEW_TIME = cprnm_TimeType__init_($rt_s(1689), 8);
    cprnm_TimeType_LAST_MERCHANT_VIEW_TIME = cprnm_TimeType__init_($rt_s(1690), 9);
    cprnm_TimeType_LAST_MERCENARY_EARN_RESET = cprnm_TimeType__init_($rt_s(1691), 10);
    cprnm_TimeType_LAST_PURCHASE = cprnm_TimeType__init_($rt_s(1692), 11);
    cprnm_TimeType_LAST_EVENT_CHEST_RESET = cprnm_TimeType__init_($rt_s(1693), 12);
    cprnm_TimeType_MONTHLY_CARD_EXPIRE_TIME = cprnm_TimeType__init_($rt_s(1694), 13);
    cprnm_TimeType_TEMPLE_EXPIRATION = cprnm_TimeType__init_($rt_s(1695), 14);
    cprnm_TimeType_LAST_GUILD_WALL_VIEW = cprnm_TimeType__init_($rt_s(1696), 15);
    cprnm_TimeType_LAST_SOUL_CHEST_RESET = cprnm_TimeType__init_($rt_s(1697), 16);
    cprnm_TimeType_DOUBLE_NORMAL_DROP_ITEM_END = cprnm_TimeType__init_($rt_s(1698), 17);
    cprnm_TimeType_DOUBLE_ELITE_DROP_ITEM_END = cprnm_TimeType__init_($rt_s(1699), 18);
    cprnm_TimeType_LAST_MONTHLY_SERVER_SIGNIN = cprnm_TimeType__init_($rt_s(1700), 19);
    cprnm_TimeType_LAST_DOUBLE_NORMAL_PAUSE = cprnm_TimeType__init_($rt_s(1701), 20);
    cprnm_TimeType_LAST_DOUBLE_ELITE_PAUSE = cprnm_TimeType__init_($rt_s(1702), 21);
    cprnm_TimeType_GUILD_LEAVE_TIME = cprnm_TimeType__init_($rt_s(1703), 22);
    cprnm_TimeType_TEMPORARY_VIP_END = cprnm_TimeType__init_($rt_s(1704), 23);
    cprnm_TimeType_LAST_TIME_ZONE_CHANGE = cprnm_TimeType__init_($rt_s(1705), 24);
    cprnm_TimeType_CHAT_APP_AUTH_TOKEN_IAT = cprnm_TimeType__init_($rt_s(1706), 25);
    cprnm_TimeType_CHAT_APP_LAST_LOGIN = cprnm_TimeType__init_($rt_s(1707), 26);
    cprnm_TimeType_LAPSED_CATCH_UP_LAST_LOGOUT = cprnm_TimeType__init_($rt_s(1708), 27);
    cprnm_TimeType_LAST_CHESTS_VIEW_TIME = cprnm_TimeType__init_($rt_s(1709), 28);
    cprnm_TimeType_DOUBLE_NORMAL_DROP_ITEM_START = cprnm_TimeType__init_($rt_s(1710), 29);
    cprnm_TimeType_DOUBLE_ELITE_DROP_ITEM_START = cprnm_TimeType__init_($rt_s(1711), 30);
    cprnm_TimeType_SUSPENSION_END = cprnm_TimeType__init_($rt_s(1712), 31);
    cprnm_TimeType_LAST_SUSPENSION_TIME = cprnm_TimeType__init_($rt_s(1713), 32);
    cprnm_TimeType_CRAFT_SUCCESS_START = cprnm_TimeType__init_($rt_s(1714), 33);
    cprnm_TimeType_CRAFT_SUCCESS_END = cprnm_TimeType__init_($rt_s(1715), 34);
    cprnm_TimeType_XP_BONUS_TEAM_START = cprnm_TimeType__init_($rt_s(1716), 35);
    cprnm_TimeType_XP_BONUS_TEAM_END = cprnm_TimeType__init_($rt_s(1717), 36);
    cprnm_TimeType_XP_BONUS_TEAM_PAUSE = cprnm_TimeType__init_($rt_s(1718), 37);
    cprnm_TimeType_DOUBLE_EXPERT_DROP_ITEM_START = cprnm_TimeType__init_($rt_s(1719), 38);
    cprnm_TimeType_DOUBLE_EXPERT_DROP_ITEM_END = cprnm_TimeType__init_($rt_s(1720), 39);
    cprnm_TimeType_LAST_DOUBLE_EXPERT_PAUSE = cprnm_TimeType__init_($rt_s(1721), 40);
...
oacl_LogFactory_getLog = $clazz => {
    oacl_LogFactory_$callClinit();
    return oacl_SimpleLog__init_(jl_Class_getName($clazz));
},
oacl_LogFactory_getInstance0 = ($this, $clazz) => {
    return oacl_SimpleLog__init_(jl_Class_getName($clazz));
},
oacl_LogFactory_getInstance = ($this, $name) => {
    return oacl_SimpleLog__init_($name);
},
oacl_LogFactory__clinit_ = () => {
    oacl_LogFactory_INSTANCE = oacl_LogFactory__init_0();
},
...
cprnm_MerchantType__clinit_ = () => {
    ...
    cprnm_MerchantType_NORMAL = cprnm_MerchantType__init_($rt_s(1722), 1);
    cprnm_MerchantType_FIGHT_PIT = cprnm_MerchantType__init_($rt_s(24), 2);
    cprnm_MerchantType_EXPEDITIONS = cprnm_MerchantType__init_($rt_s(1723), 3);
    cprnm_MerchantType_GUILD = cprnm_MerchantType__init_($rt_s(1595), 4);
    cprnm_MerchantType_PEDDLER = cprnm_MerchantType__init_($rt_s(1724), 5);
    cprnm_MerchantType_BLACK_MARKET = cprnm_MerchantType__init_($rt_s(1725), 6);
    cprnm_MerchantType_COLISEUM = cprnm_MerchantType__init_($rt_s(188), 7);
    cprnm_MerchantType_SOULMART = cprnm_MerchantType__init_($rt_s(1726), 8);
    cprnm_MerchantType_GUILD_WAR = cprnm_MerchantType__init_($rt_s(34), 9);
    cprnm_MerchantType_BAZAAR = cprnm_MerchantType__init_($rt_s(1727), 10);
...
function oacl_SimpleLog() {
    jl_Object.call(this);
    this.$name0 = null;
}
let oacl_SimpleLog__init_0 = ($this, $name) => {
    jl_Object__init_($this);
    $this.$name0 = $name;
},
oacl_SimpleLog__init_ = var_0 => {
    let var_1 = new oacl_SimpleLog();
    oacl_SimpleLog__init_0(var_1, var_0);
    return var_1;
},
oacl_SimpleLog_error = ($this, $message) => {
    let var$2, var$3, var$4, var$5;
    var$2 = jl_System_out();
    var$3 = $this.$name0;
    var$4 = jl_String_valueOf($message);
    var$5 = jl_StringBuilder__init_();
    jl_StringBuilder_append(jl_StringBuilder_append(jl_StringBuilder_append(jl_StringBuilder_append(var$5, $rt_s(1728)), var$3), $rt_s(1729)), var$4);
    var$2.$println(jl_StringBuilder_toString(var$5));
},
...
let cprnm_RandomSeedType_SHRINE_STONE_KEYSTONE = null,
...
cprnm_RandomSeedType_SHRINE_WOODEN_MINOR_2 = null,
...
cprnm_RandomSeedType__clinit_ = () => {
    ...
    cprnm_RandomSeedType_CHEST = cprnm_RandomSeedType__init_($rt_s(1730), 1);
    cprnm_RandomSeedType_ALCHEMY = cprnm_RandomSeedType__init_($rt_s(1731), 2);
    cprnm_RandomSeedType_LOOT = cprnm_RandomSeedType__init_($rt_s(1732), 3);
    cprnm_RandomSeedType_COMBAT = cprnm_RandomSeedType__init_($rt_s(1733), 4);
    ...
    cprnm_RandomSeedType_MERCHANT = cprnm_RandomSeedType__init_($rt_s(1734), 7);
    ...
    cprnm_RandomSeedType_CHEST_SILVER_1 = cprnm_RandomSeedType__init_($rt_s(1735), 10);
    cprnm_RandomSeedType_CHEST_SILVER_10 = cprnm_RandomSeedType__init_($rt_s(1736), 11);
    cprnm_RandomSeedType_CHEST_GOLD_1 = cprnm_RandomSeedType__init_($rt_s(1737), 12);
    cprnm_RandomSeedType_CHEST_GOLD_10 = cprnm_RandomSeedType__init_($rt_s(1738), 13);
    cprnm_RandomSeedType_CHEST_SOUL = cprnm_RandomSeedType__init_($rt_s(1739), 14);
    cprnm_RandomSeedType_CHEST_EVENT_1 = cprnm_RandomSeedType__init_($rt_s(1740), 15);
    cprnm_RandomSeedType_CHEST_EVENT_10 = cprnm_RandomSeedType__init_($rt_s(1741), 16);
    cprnm_RandomSeedType_GUILD_WAR = cprnm_RandomSeedType__init_($rt_s(34), 17);
    cprnm_RandomSeedType_GUILD_WAR_REWARDS = cprnm_RandomSeedType__init_($rt_s(1742), 18);
    cprnm_RandomSeedType_RUNES = cprnm_RandomSeedType__init_($rt_s(53), 19);
    cprnm_RandomSeedType_SHRINE_WOODEN_DEFAULT = cprnm_RandomSeedType__init_($rt_s(1743), 20);
    cprnm_RandomSeedType_SHRINE_WOODEN_KEYSTONE = cprnm_RandomSeedType__init_($rt_s(1744), 21);
    cprnm_RandomSeedType_SHRINE_WOODEN_MAJOR_1 = cprnm_RandomSeedType__init_($rt_s(1745), 22);
    cprnm_RandomSeedType_SHRINE_WOODEN_MAJOR_2 = cprnm_RandomSeedType__init_($rt_s(1746), 23);
    cprnm_RandomSeedType_SHRINE_WOODEN_MINOR_1 = cprnm_RandomSeedType__init_($rt_s(1747), 24);
    cprnm_RandomSeedType_SHRINE_WOODEN_MINOR_2 = cprnm_RandomSeedType__init_($rt_s(1748), 25);
    cprnm_RandomSeedType_SHRINE_WOODEN_MINOR_3 = cprnm_RandomSeedType__init_($rt_s(1749), 26);
    cprnm_RandomSeedType_SHRINE_STONE_DEFAULT = cprnm_RandomSeedType__init_($rt_s(1750), 27);
    cprnm_RandomSeedType_SHRINE_STONE_KEYSTONE = cprnm_RandomSeedType__init_($rt_s(1751), 28);
    cprnm_RandomSeedType_SHRINE_STONE_MAJOR_1 = cprnm_RandomSeedType__init_($rt_s(1752), 29);
    cprnm_RandomSeedType_SHRINE_STONE_MAJOR_2 = cprnm_RandomSeedType__init_($rt_s(1753), 30);
    cprnm_RandomSeedType_SHRINE_STONE_MINOR_1 = cprnm_RandomSeedType__init_($rt_s(1754), 31);
    cprnm_RandomSeedType_SHRINE_STONE_MINOR_2 = cprnm_RandomSeedType__init_($rt_s(1755), 32);
    cprnm_RandomSeedType_SHRINE_STONE_MINOR_3 = cprnm_RandomSeedType__init_($rt_s(1756), 33);
    cprnm_RandomSeedType_SHRINE_CRYSTAL_KEYSTONE = cprnm_RandomSeedType__init_($rt_s(1757), 34);
    cprnm_RandomSeedType_SHRINE_CRYSTAL_MAJOR_1 = cprnm_RandomSeedType__init_($rt_s(1758), 35);
    cprnm_RandomSeedType_SHRINE_CRYSTAL_MAJOR_2 = cprnm_RandomSeedType__init_($rt_s(1759), 36);
    cprnm_RandomSeedType_SHRINE_CRYSTAL_MINOR_1 = cprnm_RandomSeedType__init_($rt_s(1760), 37);
    cprnm_RandomSeedType_SHRINE_CRYSTAL_MINOR_2 = cprnm_RandomSeedType__init_($rt_s(1761), 38);
    cprnm_RandomSeedType_SHRINE_CRYSTAL_MINOR_3 = cprnm_RandomSeedType__init_($rt_s(1762), 39);
    cprnm_RandomSeedType_BOSS_PIT_LOOT = cprnm_RandomSeedType__init_($rt_s(1763), 40);
    cprnm_RandomSeedType_DIFFICULTY_MODE_LOOT = cprnm_RandomSeedType__init_($rt_s(1764), 41);
    cprnm_RandomSeedType_EXPEDITION_CHEST = cprnm_RandomSeedType__init_($rt_s(1765), 42);
    cprnm_RandomSeedType_CHEST_PURPLE_1 = cprnm_RandomSeedType__init_($rt_s(1766), 43);
    cprnm_RandomSeedType_CHEST_PURPLE_10 = cprnm_RandomSeedType__init_($rt_s(1767), 44);
    cprnm_RandomSeedType_CHEST_ORANGE_1 = cprnm_RandomSeedType__init_($rt_s(1768), 45);
    cprnm_RandomSeedType_CHEST_ORANGE_10 = cprnm_RandomSeedType__init_($rt_s(1769), 46);
...
cprnm_GuildRole__clinit_ = () => {
    let var$1, var$2;
    cprnm_GuildRole_MEMBER = cprnm_GuildRole__init_($rt_s(1770), 0);
    cprnm_GuildRole_RULER = cprnm_GuildRole__init_($rt_s(1771), 1);
    cprnm_GuildRole_OFFICER = cprnm_GuildRole__init_($rt_s(1772), 2);
    cprnm_GuildRole_CHAMPION = cprnm_GuildRole__init_($rt_s(1773), 3);
    cprnm_GuildRole_VETERAN = cprnm_GuildRole__init_($rt_s(1774), 4);
    cprnm_GuildRole_NONE = cprnm_GuildRole__init_($rt_s(1775), 5);
...
cprgo_UserFlag__clinit_ = () => {
    let var$1, var$2;
    cprgo_UserFlag_SILVER_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1777), 0);
    cprgo_UserFlag_GOLD_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1778), 1);
    cprgo_UserFlag_SOUL_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1779), 2);
    cprgo_UserFlag_PURPLE_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1780), 3);
    cprgo_UserFlag_ORANGE_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1781), 4);
    cprgo_UserFlag_CAMPAIGN_BATTLES_DONE = cprgo_UserFlag__init_($rt_s(1782), 5);
    cprgo_UserFlag_ELITE_CAMPAIGN_BATTLES_DONE = cprgo_UserFlag__init_($rt_s(1783), 6);
    cprgo_UserFlag_CAMPAIGN_UNLOCKED = cprgo_UserFlag__init_($rt_s(1784), 7);
    cprgo_UserFlag_MONTHLY_DIAMOND_DAYS = cprgo_UserFlag__init_($rt_s(1785), 8);
    cprgo_UserFlag_FREE_NAME_CHANGE = cprgo_UserFlag__init_($rt_s(1786), 9);
    cprgo_UserFlag_FIGHT_PIT_VICTORIES = cprgo_UserFlag__init_($rt_s(1787), 10);
    cprgo_UserFlag_CAMPAIGN_KILLS = cprgo_UserFlag__init_($rt_s(1788), 11);
    cprgo_UserFlag_MERCENARY_GOLD = cprgo_UserFlag__init_($rt_s(1789), 12);
    cprgo_UserFlag_BETA_0_2 = cprgo_UserFlag__init_($rt_s(1790), 13);
    cprgo_UserFlag_NO_LOOT_LAST_BATTLE = cprgo_UserFlag__init_($rt_s(1791), 14);
    cprgo_UserFlag_BETA_0_3 = cprgo_UserFlag__init_($rt_s(1792), 15);
    cprgo_UserFlag_WW_1_0 = cprgo_UserFlag__init_($rt_s(1793), 16);
    cprgo_UserFlag_SILVER_10_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1794), 17);
    cprgo_UserFlag_GOLD_10_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1795), 18);
    cprgo_UserFlag_PURPLE_10_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1796), 19);
    cprgo_UserFlag_ORANGE_10_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1797), 20);
    cprgo_UserFlag_CHATS = cprgo_UserFlag__init_($rt_s(1798), 21);
    cprgo_UserFlag_LAST_CRYPT_SCORE = cprgo_UserFlag__init_($rt_s(1799), 22);
    cprgo_UserFlag_EVENT_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1800), 23);
    cprgo_UserFlag_EVENT_10_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1801), 24);
    cprgo_UserFlag_COLISEUM_RUNS = cprgo_UserFlag__init_($rt_s(1802), 25);
    cprgo_UserFlag_COLISEUM_VICTORIES = cprgo_UserFlag__init_($rt_s(1803), 26);
    cprgo_UserFlag_FREE_TIME_ZONE_RESET = cprgo_UserFlag__init_($rt_s(1804), 27);
    cprgo_UserFlag_UNLOCKED_HARD_EXPEDITION = cprgo_UserFlag__init_($rt_s(1805), 28);
    cprgo_UserFlag_FACEBOOK_LIKED = cprgo_UserFlag__init_($rt_s(1806), 29);
    cprgo_UserFlag_HOW_TO_PLAY_EXPEDITION = cprgo_UserFlag__init_($rt_s(1807), 30);
    cprgo_UserFlag_HOW_TO_PLAY_VIP = cprgo_UserFlag__init_($rt_s(1808), 31);
    cprgo_UserFlag_VIEWED_CRYPT_RESULTS = cprgo_UserFlag__init_($rt_s(1809), 32);
    cprgo_UserFlag_TITANS_KILLED = cprgo_UserFlag__init_($rt_s(1810), 33);
    cprgo_UserFlag_TEMPLE_INVITES = cprgo_UserFlag__init_($rt_s(1811), 34);
    cprgo_UserFlag_TEMPLE_STAMINA_MEMORY = cprgo_UserFlag__init_($rt_s(1812), 35);
    cprgo_UserFlag_TEMPLE_WIN_STREAK = cprgo_UserFlag__init_($rt_s(1813), 36);
    cprgo_UserFlag_NEW_CHEST_SEEDS = cprgo_UserFlag__init_($rt_s(1814), 37);
    cprgo_UserFlag_REPLAYKIT_COUNT = cprgo_UserFlag__init_($rt_s(1815), 38);
    cprgo_UserFlag_NOT_FIRST_ACCOUNT = cprgo_UserFlag__init_($rt_s(1816), 39);
    cprgo_UserFlag_PROMO_CODE_ATTEMPTS = cprgo_UserFlag__init_($rt_s(1817), 40);
    cprgo_UserFlag_VIEWED_LAST_CHANCE_PROMO_WINDOW = cprgo_UserFlag__init_($rt_s(1818), 41);
    cprgo_UserFlag_PAID_SOUL_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1819), 42);
    cprgo_UserFlag_VIEWED_SOULMART_INFO = cprgo_UserFlag__init_($rt_s(1820), 43);
    cprgo_UserFlag_FREE_GOLD_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1821), 44);
    cprgo_UserFlag_FREE_PURPLE_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1822), 45);
    cprgo_UserFlag_FREE_ORANGE_CHEST_ROLLS = cprgo_UserFlag__init_($rt_s(1823), 46);
    cprgo_UserFlag_TEMPROARY_VIP_LEVEL = cprgo_UserFlag__init_($rt_s(1824), 47);
    cprgo_UserFlag_VIEWED_BATTLE_STATS = cprgo_UserFlag__init_($rt_s(1825), 48);
    cprgo_UserFlag_L15_RUNES_CREATED = cprgo_UserFlag__init_($rt_s(1826), 49);
    cprgo_UserFlag_GOT_TUTORIAL_RUNE = cprgo_UserFlag__init_($rt_s(1827), 50);
    cprgo_UserFlag_OPTED_OUT_OF_WAR = cprgo_UserFlag__init_($rt_s(1828), 51);
    cprgo_UserFlag_WAR_ATTACK_ATTEMPTS = cprgo_UserFlag__init_($rt_s(1829), 52);
    cprgo_UserFlag_GOT_TUTORIAL_RUNE_OFFERING = cprgo_UserFlag__init_($rt_s(1830), 53);
    cprgo_UserFlag_TUTORIAL_RIGGED_RUNE_SHRINE = cprgo_UserFlag__init_($rt_s(1831), 54);
    cprgo_UserFlag_FAILED_AN_EMPOWER = cprgo_UserFlag__init_($rt_s(1832), 55);
    cprgo_UserFlag_MONTHLY_PURCHASE = cprgo_UserFlag__init_($rt_s(1833), 56);
    cprgo_UserFlag_HAS_SEEN_CONTEST_START = cprgo_UserFlag__init_($rt_s(1834), 57);
    cprgo_UserFlag_HAS_NEW_MAINSCREEN_CONTEST_PROGRESS = cprgo_UserFlag__init_($rt_s(1835), 58);
    cprgo_UserFlag_IS_RUNE_TOGGLE_ON = cprgo_UserFlag__init_($rt_s(1836), 59);
    cprgo_UserFlag_CHAT_APP_REWARD_SENT = cprgo_UserFlag__init_($rt_s(1837), 60);
    cprgo_UserFlag_IN_LAPSED_CATCH_UP_PERIOD = cprgo_UserFlag__init_($rt_s(1838), 61);
    cprgo_UserFlag_COMMUNITY_BUTTON_SHOWN_NAME_CHANGE_PROMPT = cprgo_UserFlag__init_($rt_s(1839), 62);
    cprgo_UserFlag_EVENTS_WINDOW_ON_MAINSCREEN = cprgo_UserFlag__init_($rt_s(1840), 63);
    cprgo_UserFlag_HAS_SKIN_FOR_TUTORIAL = cprgo_UserFlag__init_($rt_s(1841), 64);
    cprgo_UserFlag_AB_VIP5_FREE_CONSUMABLE_SHOULD_BE_GIVEN = cprgo_UserFlag__init_($rt_s(1842), 65);
    cprgo_UserFlag_EXPEDITION_MAX_DIFFICULTY = cprgo_UserFlag__init_($rt_s(1843), 66);
    cprgo_UserFlag_VIP_TICKET_FIXED = cprgo_UserFlag__init_($rt_s(1844), 67);
    cprgo_UserFlag_FIGHT_PIT_BATTLE_COUNT = cprgo_UserFlag__init_($rt_s(1845), 68);
    cprgo_UserFlag_COLISEUM_BATTLE_COUNT = cprgo_UserFlag__init_($rt_s(1846), 69);
    cprgo_UserFlag_CRYPT_BATTLE_COUNT = cprgo_UserFlag__init_($rt_s(1847), 70);
    cprgo_UserFlag_CRYPT_RAID_WIN_COUNT = cprgo_UserFlag__init_($rt_s(1848), 71);
    cprgo_UserFlag_CRYPT_OPPONENTS_DEFEAT_COUNT = cprgo_UserFlag__init_($rt_s(1849), 72);
    cprgo_UserFlag_CRYPT_OPPONENT_HEROES_DEFEAT_COUNT = cprgo_UserFlag__init_($rt_s(1850), 73);
    cprgo_UserFlag_EXPEDITION_BATTLE_COUNT = cprgo_UserFlag__init_($rt_s(1851), 74);
    cprgo_UserFlag_BOSS_PIT_BATTLE_COUNT = cprgo_UserFlag__init_($rt_s(1852), 75);
    cprgo_UserFlag_TEMPLE_WIN_COUNT = cprgo_UserFlag__init_($rt_s(1853), 76);
    cprgo_UserFlag_CONTEST_PARTICIPATION_COUNT = cprgo_UserFlag__init_($rt_s(1854), 77);
    cprgo_UserFlag_BOSS_BATTLE_COUNT = cprgo_UserFlag__init_($rt_s(1855), 78);
    cprgo_UserFlag_EXPERT_CAMPAIGN_BATTLES_DONE = cprgo_UserFlag__init_($rt_s(1856), 79);
...
cpaa_l__clinit_ = () => {
    let var$1, var$2;
    cpaa_l_a = cpaa_l__init_($rt_s(1857), 0, 42);
    cpaa_l_b = cpaa_l__init_($rt_s(1858), 1, 43);
...
cprnm_ChatRoomType__clinit_ = () => {
    let var$1, var$2;
    cprnm_ChatRoomType_GLOBAL = cprnm_ChatRoomType__init_($rt_s(1859), 0);
    cprnm_ChatRoomType_GUILD = cprnm_ChatRoomType__init_($rt_s(1595), 1);
    cprnm_ChatRoomType_HERO_WALL = cprnm_ChatRoomType__init_($rt_s(1860), 2);
    cprnm_ChatRoomType_VIP = cprnm_ChatRoomType__init_($rt_s(1589), 3);
    cprnm_ChatRoomType_GUILD_WALL = cprnm_ChatRoomType__init_($rt_s(1861), 4);
    cprnm_ChatRoomType_PERSONAL_MESSAGE = cprnm_ChatRoomType__init_($rt_s(1862), 5);
...
cpr_ServerType__clinit_ = () => {
    let var$1, var$2;
    cpr_ServerType_NONE = cpr_ServerType__init_($rt_s(1775), 0, $rt_s(91), $rt_s(91), 0, $rt_s(91));
    cpr_ServerType_LOCAL = cpr_ServerType__init_($rt_s(1863), 1, $rt_s(1864), $rt_s(1865), 8080, $rt_s(1866));
    cpr_ServerType_TRUNK = cpr_ServerType__init_($rt_s(1867), 2, $rt_s(1868), $rt_s(1869), 8080, $rt_s(1870));
    cpr_ServerType_DEV = cpr_ServerType__init_($rt_s(1871), 3, $rt_s(1868), $rt_s(1872), 8080, $rt_s(1866));
    cpr_ServerType_QA1 = cpr_ServerType__init_($rt_s(1873), 4, $rt_s(1868), $rt_s(1874), 443, $rt_s(1875));
    cpr_ServerType_QA2 = cpr_ServerType__init_($rt_s(1876), 5, $rt_s(1868), $rt_s(1877), 443, $rt_s(1878));
    cpr_ServerType_LIVE = cpr_ServerType__init_($rt_s(1879), 6, $rt_s(1864), $rt_s(1880), 8080, $rt_s(1881));
...
juc_TimeUnit__clinit_ = () => {
    juc_TimeUnit_NANOSECONDS = juc_TimeUnit__init_($rt_s(1885), 0, Long_fromInt(1));
    juc_TimeUnit_MICROSECONDS = juc_TimeUnit__init_($rt_s(1886), 1, Long_fromInt(1000));
    juc_TimeUnit_MILLISECONDS = juc_TimeUnit__init_($rt_s(1887), 2, Long_fromInt(1000000));
    juc_TimeUnit_SECONDS = juc_TimeUnit__init_($rt_s(1888), 3, Long_fromInt(1000000000));
    juc_TimeUnit_MINUTES = juc_TimeUnit__init_($rt_s(1889), 4, Long_create(4165425152, 13));
    juc_TimeUnit_HOURS = juc_TimeUnit__init_($rt_s(1890), 5, Long_create(817405952, 838));
    juc_TimeUnit_DAYS = juc_TimeUnit__init_($rt_s(1891), 6, Long_create(2437873664, 20116));
...
cpr_ToolType__clinit_ = () => {
    let var$1, var$2;
    cpr_ToolType_NONE = cpr_ToolType__init_($rt_s(1775), 0);
    cpr_ToolType_ANIMATION = cpr_ToolType__init_($rt_s(1893), 1);
    cpr_ToolType_COMBAT_SIMULATOR = cpr_ToolType__init_($rt_s(1894), 2);
    cpr_ToolType_COMBAT_RENDER = cpr_ToolType__init_($rt_s(1895), 3);
    cpr_ToolType_COMBAT_AUTOMATOR = cpr_ToolType__init_($rt_s(1896), 4);
    cpr_ToolType_COMBAT_SIMULATOR_RANDOM = cpr_ToolType__init_($rt_s(1897), 5);
...
$rt_packages([-1, "com", 0, "perblue", 1, "common", 2, "h", 1, "rpg", -1, "java", 5, "lang"
]);
$rt_metadata([jl_Object, "Object", 6, 0, [], 0, 3, 0, 0, ["$getClass0", $rt_wrapFunction0(jl_Object_getClass), "$hashCode", $rt_wrapFunction0(jl_Object_hashCode), "$equals", $rt_wrapFunction1(jl_Object_equals), "$toString", $rt_wrapFunction0(jl_Object_toString), "$identity", $rt_wrapFunction0(jl_Object_identity), "$clone0", $rt_wrapFunction0(jl_Object_clone)],
...
cpch_a, "a", 3, jl_Object, [], 1, 3, 0, cpch_a_$callClinit, 0,
...
cpr_RPGMain, "RPGMain", 4, cbg_b, [], 0, 3, 0, cpr_RPGMain_$callClinit, ["$_init_23", $rt_wrapFunction1(cpr_RPGMain__init_0), "$_init_13", $rt_wrapFunction3(cpr_RPGMain__init_)],
...
cpru_DeviceInfo, 0, jl_Object, [], 3, 3, 0, 0, 0,
WebDeviceInfo, 0, jl_Object, [cpru_DeviceInfo], 0, 3, 0, 0, ["$_init_", $rt_wrapFunction0(WebDeviceInfo__init_)],
...
$rt_metadata([ju_LinkedList$SequentialListIterator, 0, jl_Object, [ju_ListIterator], 0, 0, 0, 0, ["$_init_21", $rt_wrapFunction4(ju_LinkedList$SequentialListIterator__init_0), "$add1", $rt_wrapFunction1(ju_LinkedList$SequentialListIterator_add)],
cprt_Vector3Accessor, 0, jl_Object, [aa_e], 0, 3, 0, cprt_Vector3Accessor_$callClinit, ["$_init_", $rt_wrapFunction0(cprt_Vector3Accessor__init_)],
...
cpr_PerfStats, "PerfStats", 4, jl_Object, [], 0, 3, 0, cpr_PerfStats_$callClinit, 0,
cpru_PlayingSound, 0, jl_Object, [cbgu_ac$a], 0, 3, 0, 0, 0,
oacl_Log, 0, jl_Object, [], 3, 3, 0, 0, 0,
oacl_SimpleLog, 0, jl_Object, [oacl_Log], 0, 3, 0, 0, ["$_init_0", $rt_wrapFunction1(oacl_SimpleLog__init_0), "$error", $rt_wrapFunction1(oacl_SimpleLog_error)],
...
"DragonSoul Web - Phase 3.1", "RPGMain instancie avec succes", "PrivateUserInfo1", "BossPitData1", "LAST_NON_FREE_TIME_ZONE_CHANGE", "CHAT_SILENCE_END", "MONTHLY_DIAMOND_END", "LAST_DAILY_RESET", "LAST_MONTHLY_SIGNIN", "LAST_SPECIAL_EVENT_CHECK", "LAST_USER_DAILY_RESET", "LAST_EVENT_VIEW_TIME", "LAST_MERCHANT_VIEW_TIME", "LAST_MERCENARY_EARN_RESET", "LAST_PURCHASE", "LAST_EVENT_CHEST_RESET", "MONTHLY_CARD_EXPIRE_TIME", "TEMPLE_EXPIRATION", "LAST_GUILD_WALL_VIEW", "LAST_SOUL_CHEST_RESET", "DOUBLE_NORMAL_DROP_ITEM_END",
"DOUBLE_ELITE_DROP_ITEM_END", "LAST_MONTHLY_SERVER_SIGNIN", "LAST_DOUBLE_NORMAL_PAUSE", "LAST_DOUBLE_ELITE_PAUSE", "GUILD_LEAVE_TIME", "TEMPORARY_VIP_END", "LAST_TIME_ZONE_CHANGE", "CHAT_APP_AUTH_TOKEN_IAT", "CHAT_APP_LAST_LOGIN", "LAPSED_CATCH_UP_LAST_LOGOUT", "LAST_CHESTS_VIEW_TIME", "DOUBLE_NORMAL_DROP_ITEM_START", "DOUBLE_ELITE_DROP_ITEM_START", "SUSPENSION_END", "LAST_SUSPENSION_TIME", "CRAFT_SUCCESS_START", "CRAFT_SUCCESS_END", "XP_BONUS_TEAM_START", "XP_BONUS_TEAM_END", "XP_BONUS_TEAM_PAUSE", "DOUBLE_EXPERT_DROP_ITEM_START",
"DOUBLE_EXPERT_DROP_ITEM_END", "LAST_DOUBLE_EXPERT_PAUSE", "NORMAL", "EXPEDITIONS", "PEDDLER", "BLACK_MARKET", "SOULMART", "BAZAAR", "[ERROR] ", ": ", "CHEST", "ALCHEMY", "LOOT", "COMBAT", "MERCHANT", "CHEST_SILVER_1", "CHEST_SILVER_10", "CHEST_GOLD_1", "CHEST_GOLD_10", "CHEST_SOUL", "CHEST_EVENT_1", "CHEST_EVENT_10", "GUILD_WAR_REWARDS", "SHRINE_WOODEN_DEFAULT", "SHRINE_WOODEN_KEYSTONE", "SHRINE_WOODEN_MAJOR_1", "SHRINE_WOODEN_MAJOR_2", "SHRINE_WOODEN_MINOR_1", "SHRINE_WOODEN_MINOR_2", "SHRINE_WOODEN_MINOR_3",
"SHRINE_STONE_DEFAULT", "SHRINE_STONE_KEYSTONE", "SHRINE_STONE_MAJOR_1", "SHRINE_STONE_MAJOR_2", "SHRINE_STONE_MINOR_1", "SHRINE_STONE_MINOR_2", "SHRINE_STONE_MINOR_3", "SHRINE_CRYSTAL_KEYSTONE", "SHRINE_CRYSTAL_MAJOR_1", "SHRINE_CRYSTAL_MAJOR_2", "SHRINE_CRYSTAL_MINOR_1", "SHRINE_CRYSTAL_MINOR_2", "SHRINE_CRYSTAL_MINOR_3", "BOSS_PIT_LOOT", "DIFFICULTY_MODE_LOOT", "EXPEDITION_CHEST", "CHEST_PURPLE_1", "CHEST_PURPLE_10", "CHEST_ORANGE_1", "CHEST_ORANGE_10", "MEMBER", "RULER", "OFFICER", "CHAMPION", "VETERAN",
"NONE", "Avatar1", "SILVER_CHEST_ROLLS", "GOLD_CHEST_ROLLS", "SOUL_CHEST_ROLLS", "PURPLE_CHEST_ROLLS", "ORANGE_CHEST_ROLLS", "CAMPAIGN_BATTLES_DONE", "ELITE_CAMPAIGN_BATTLES_DONE", "CAMPAIGN_UNLOCKED", "MONTHLY_DIAMOND_DAYS", "FREE_NAME_CHANGE", "FIGHT_PIT_VICTORIES", "CAMPAIGN_KILLS", "MERCENARY_GOLD", "BETA_0_2", "NO_LOOT_LAST_BATTLE", "BETA_0_3", "WW_1_0", "SILVER_10_CHEST_ROLLS", "GOLD_10_CHEST_ROLLS", "PURPLE_10_CHEST_ROLLS", "ORANGE_10_CHEST_ROLLS", "CHATS", "LAST_CRYPT_SCORE", "EVENT_CHEST_ROLLS", "EVENT_10_CHEST_ROLLS",
"COLISEUM_RUNS", "COLISEUM_VICTORIES", "FREE_TIME_ZONE_RESET", "UNLOCKED_HARD_EXPEDITION", "FACEBOOK_LIKED", "HOW_TO_PLAY_EXPEDITION", "HOW_TO_PLAY_VIP", "VIEWED_CRYPT_RESULTS", "TITANS_KILLED", "TEMPLE_INVITES", "TEMPLE_STAMINA_MEMORY", "TEMPLE_WIN_STREAK", "NEW_CHEST_SEEDS", "REPLAYKIT_COUNT", "NOT_FIRST_ACCOUNT", "PROMO_CODE_ATTEMPTS", "VIEWED_LAST_CHANCE_PROMO_WINDOW", "PAID_SOUL_CHEST_ROLLS", "VIEWED_SOULMART_INFO", "FREE_GOLD_CHEST_ROLLS", "FREE_PURPLE_CHEST_ROLLS", "FREE_ORANGE_CHEST_ROLLS", "TEMPROARY_VIP_LEVEL",
"VIEWED_BATTLE_STATS", "L15_RUNES_CREATED", "GOT_TUTORIAL_RUNE", "OPTED_OUT_OF_WAR", "WAR_ATTACK_ATTEMPTS", "GOT_TUTORIAL_RUNE_OFFERING", "TUTORIAL_RIGGED_RUNE_SHRINE", "FAILED_AN_EMPOWER", "MONTHLY_PURCHASE", "HAS_SEEN_CONTEST_START", "HAS_NEW_MAINSCREEN_CONTEST_PROGRESS", "IS_RUNE_TOGGLE_ON", "CHAT_APP_REWARD_SENT", "IN_LAPSED_CATCH_UP_PERIOD", "COMMUNITY_BUTTON_SHOWN_NAME_CHANGE_PROMPT", "EVENTS_WINDOW_ON_MAINSCREEN", "HAS_SKIN_FOR_TUTORIAL", "AB_VIP5_FREE_CONSUMABLE_SHOULD_BE_GIVEN", "EXPEDITION_MAX_DIFFICULTY",
"VIP_TICKET_FIXED", "FIGHT_PIT_BATTLE_COUNT", "COLISEUM_BATTLE_COUNT", "CRYPT_BATTLE_COUNT", "CRYPT_RAID_WIN_COUNT", "CRYPT_OPPONENTS_DEFEAT_COUNT", "CRYPT_OPPONENT_HEROES_DEFEAT_COUNT", "EXPEDITION_BATTLE_COUNT", "BOSS_PIT_BATTLE_COUNT", "TEMPLE_WIN_COUNT", "CONTEST_PARTICIPATION_COUNT", "BOSS_BATTLE_COUNT", "EXPERT_CAMPAIGN_BATTLES_DONE", "V1", "V2", "GLOBAL", "HERO_WALL", "GUILD_WALL", "PERSONAL_MESSAGE", "LOCAL", "http://", "localhost", "http://s3.amazonaws.com/qa-content.dragonsoulgame.com/dev/index.txt",
"TRUNK", "https://", "trunk.dragonsoulgame.com", "http://s3.amazonaws.com/qa-content.dragonsoulgame.com/trunk/index.txt", "DEV", "dev.dragonsoulgame.com", "QA1", "qa1.dragonsoulgame.com", "http://s3.amazonaws.com/qa-content.dragonsoulgame.com/qa1/index.txt", "QA2", "qa2.dragonsoulgame.com", "http://s3.amazonaws.com/qa-content.dragonsoulgame.com/qa2/index.txt", "LIVE", "127.0.0.1", "http://127.0.0.1:8080/live/index.txt", "BasicUserInfo1", "GuildInfo1", "IAPProducts1", "NANOSECONDS", "MICROSECONDS", "MILLISECONDS",
"SECONDS", "MINUTES", "HOURS", "DAYS", "BasicGuildInfo1", "ANIMATION", "COMBAT_SIMULATOR", "COMBAT_RENDER", "COMBAT_AUTOMATOR", "COMBAT_SIMULATOR_RANDOM"]);
