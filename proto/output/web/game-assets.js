...
(function(root) {
    ...
    // Fix 76: GAME_ASSETS_RGBA must be initialized so cbgaa_n_b bypass code runs
    // Without this, typeof window.GAME_ASSETS_RGBA !== 'undefined' is false,
    // and the Fix 75c PNG decode + stub texture path is never reached → texture=null → NaN UV
    if (!root.GAME_ASSETS_RGBA) root.GAME_ASSETS_RGBA = {};
