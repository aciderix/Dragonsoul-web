...
[ -n "$DS_TRACE_SCREEN" ] && EXTRA="$EXTRA -DDS_TRACE_SCREEN=$DS_TRACE_SCREEN"
[ -n "$DS_TRACE_USER" ] && EXTRA="$EXTRA -DDS_TRACE_USER=$DS_TRACE_USER"
[ -n "$DS_PROBE_CONTENT" ] && EXTRA="$EXTRA -DDS_PROBE_CONTENT=$DS_PROBE_CONTENT"
[ -n "$DS_SAVE_FILE" ] && EXTRA="$EXTRA -DDS_SAVE_FILE=$DS_SAVE_FILE"
[ -n "$DS_LIVE_FILE" ] && EXTRA="$EXTRA -DDS_LIVE_FILE=$DS_LIVE_FILE"
